...
public class ConvertControllerTests {
	...
	public void primitive() throws Exception {
		this.mockMvc.perform(get("/convert/primitive").param("value", "3"))
				.andDo(print()).andExpect(content().string("Converted primitive 3"));
	}
	@Ignore
	@Test
	public void date() throws Exception {
		...
		.andDo(print()).andExpect(content().string("Converted date Sun Jul 04 00:00:00 " + timezone + " 2010"));
	}
    @Ignore
	@Test
	public void collection() throws Exception {
		this.mockMvc.perform(get("/convert/collection?values=1&values=2&values=3&values=4&values=5"))
		.andDo(print()).andExpect(content().string("Converted collection [1, 2, 3, 4, 5]"));
	}
    @Ignore
	@Test
	...
	public void custom() throws Exception {
		...
		.andDo(print()).andExpect(content().string("Converted '123456789' with a custom converter"));
	}
    @Ignore
	@Test
